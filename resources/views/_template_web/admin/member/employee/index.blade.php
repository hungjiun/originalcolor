...
@section('inline-js')
    ...
    <script>
        var current_data = [];
        var ajax_source = "{{ url('web/admin/member/employee/getlist')}}";
        var ajax_Table = "{{ url('web/admin/member/employee/getlist')}}";
        var url_doadd = "{{ url('web/admin/member/employee/doadd')}}";
        var url_dosave = "{{ url('web/admin/member/employee/dosave')}}";
        var url_access = "{{ url('web/admin/member/employee/access')}}";

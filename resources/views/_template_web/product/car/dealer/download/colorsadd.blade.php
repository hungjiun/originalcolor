            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">{{trans("_menu.product.car.dealer.download.colorsadd.title")}}</h3>
...
$(document).ready(function() {
    ...
    table = $('#dt_basic').DataTable({
        ...
        "sAjaxSource": "{{ url('web/product/car/dealer/download/getcolorsaddlist')}}",
        fnServerParams: function(aoData){
            aoData.push( { "name": "iDealerId", "value": {{$iDealerId}} } );
            aoData.push( { "name": "iCarBrandId", "value": {{$iCarBrandId}} } );
        },
        "ajax": "{{ url('web/product/car/dealer/download/getcolorsaddlist')}}",
    ...
    $('.btn-save').on('click', function(){
        ...
        $.ajax({
            url : "{{ url('web/product/car/dealer/download/docolorsadd')}}",

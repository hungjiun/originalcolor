            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">{{trans("_menu.product.car.dealer.download.colors.title")}}</h3>
...
@section('inline-js')
    ...
    <script>
        var current_data = [];
        var ajax_source = "{{ url('web/product/car/dealer/download/getcolorslist')}}";
        var ajax_Table = "{{ url('web/product/car/dealer/download/getcolorslist')}}";
        var url_dosave = "{{ url('web/product/car/dealer/download/docolorssave')}}";
        var url_colorsadd = "{{ url('web/product/car/dealer/download/colorsadd')}}";
        var table;
        $(document).ready(function () {
            ...
            $(".btn-add").click(function () {
                ...
                location.href = url_colorsadd + '?iDealerId=' + iDealerId + '&iCarBrandId=' + iCarBrandId;
            });

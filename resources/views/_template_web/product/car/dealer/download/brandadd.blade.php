            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">{{trans("_menu.product.car.dealer.download.brandadd.title")}}</h3>
...
$(document).ready(function() {
    ...
    table = $('#dt_basic').DataTable({
        ...
        "sAjaxSource": "{{ url('web/product/car/dealer/download/getbrandaddlist')}}",
        "ajax": "{{ url('web/product/car/dealer/download/getbrandaddlist')}}",
    ...
    $('.btn-save').on('click', function(){
        ...
        $.ajax({
            url : "{{ url('web/product/car/dealer/download/dobrandadd')}}",

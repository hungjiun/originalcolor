            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">{{trans("_menu.product.car.dealer.download.brand.title")}}</h3>
...
@section('inline-js')
    ...
    <script>
        var current_data = [];
        var ajax_source = "{{ url('web/product/car/dealer/download/getlist')}}";
        var ajax_Table = "{{ url('web/product/car/dealer/download/getlist')}}";
        var url_dosave = "{{ url('web/product/car/dealer/download/dobrandsave')}}";
        var url_brandadd = "{{ url('web/product/car/dealer/download/brandadd')}}";
        var url_models = "{{ url('web/product/car/dealer/download/models')}}";
        var url_colors = "{{ url('web/product/car/dealer/download/colors')}}";
        var table;

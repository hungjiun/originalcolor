            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">{{trans("_menu.product.car.dealer.download.models.title")}}</h3>
...
@section('inline-js')
    ...
    <script>
        var current_data = [];
        var ajax_source = "{{ url('web/product/car/dealer/download/getmodelslist')}}";
        var ajax_Table = "{{ url('web/product/car/dealer/download/getmodelslist')}}";
        var url_dosave = "{{ url('web/product/car/dealer/download/domodelssave')}}";
        var url_modelsadd = "{{ url('web/product/car/dealer/download/modelsadd')}}";
        var table;

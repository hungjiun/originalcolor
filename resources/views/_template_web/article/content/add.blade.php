                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="vTitle" placeholder="">
                                        </div>
                                    </div>
                                    <!-- /.form-group -->
                                    <!--
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="vMeta" placeholder="">
                                        </div>
                                    </div>
                                    <!-- /.form-group -->
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control summernote" id="vDetail" placeholder="">
                                        </div>
                                    </div>
                                    <!-- /.form-group -->
                                </div>
...
@section('inline-js')
    ...
    <!--  -->
    <script>
        var url_doadd = "{{ url('web/article/content/doadd')}}";
